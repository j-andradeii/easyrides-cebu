...
export function WhyChooseUs() {
  return (
    <section className="py-14 sm:py-20 bg-cream relative overflow-hidden border-t border-cream-dark/50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            ...
            <span className="bg-gradient-to-r from-coral to-mango bg-clip-text text-transparent">EasyRideCebu</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            The details that matter when you are landing, driving, or touring somewhere new.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {reasons.slice(0, 4).map((reason, index) => (
            <div key={index} className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mt-5 mb-2 group-hover:text-coral transition-colors">{reason.title}</h3>
