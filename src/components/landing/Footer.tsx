        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-coral rounded-full flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-mango hover:to-coral rounded-full flex items-center justify-center transition-colors"
              ...
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-palm rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-sm">+63 917 804 6988</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="text-sm">trishiaandrade2708@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
