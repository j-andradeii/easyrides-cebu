        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-cebu-red rounded-full flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-cebu-gold hover:to-cebu-red rounded-full flex items-center justify-center transition-colors"
              ...
              <a
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-cebu-green rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-slate-400 hover:text-cebu-gold transition-colors text-sm"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 text-cebu-gold mt-0.5 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-slate-400 hover:text-cebu-gold transition-colors"
                >
                  <svg
                    className="w-5 h-5 text-cebu-gold mt-0.5 flex-shrink-0"
                    fill="none"
