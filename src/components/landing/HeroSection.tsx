...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-x-hidden">
      ...
      <div className="absolute top-20 -right-12 sm:right-0 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-papaya/40 to-palm-light/30 rounded-full blur-3xl animate-pulse" style={{animationDuration: '4s'}} />
      <div className="absolute bottom-20 -left-12 sm:left-0 w-40 h-40 sm:w-56 sm:h-56 md:w-80 md:h-80 bg-gradient-to-tr from-mango/40 to-coral/20 rounded-full blur-3xl animate-pulse" style={{animationDuration: '5s'}} />
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative overflow-visible">
            ...
            <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-coral/20 to-mango/20 rounded-3xl blur-2xl opacity-60" />
